...
def upload_image_path(instance,filename):
    ...
    return "samsungproducts/{new_filename}/{final_filename}".format(new_filename=filename, final_filename=final_filename)
...
class S_Product(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return  reverse("samsungproducts:detail", kwargs={"slug": self.slug})
...
pre_save.connect(product_pre_save_receiver, sender=S_Product )